...
async def test_pwm_freq(dut):
    ...
    # Expected period for 10 MHz clock with 50% duty cycle
    freq_hz = 1e9 / period_ns

    dut._log.info(f"Measured PWM frequency: {freq_hz} Hz")

    assert math.isclose(freq_hz, 3000, rel_tol=0.01)
